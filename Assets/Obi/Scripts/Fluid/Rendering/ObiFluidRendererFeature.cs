...
namespace Obi
{
    ...
    public class ObiFluidRendererFeature : UnityEngine.Rendering.Universal.ScriptableRendererFeature
    {
        [System.Serializable]
        ...
        {
            m_RenderFluidPass = new RenderFluidPass(UnityEngine.Rendering.Universal.RenderTargetHandle.CameraTarget);
            m_RenderFluidPass.renderPassEvent = UnityEngine.Rendering.Universal.RenderPassEvent.AfterRenderingSkybox;
        }
    }

    public class RenderFluidPass : UnityEngine.Rendering.Universal.ScriptableRenderPass
    {
        ...
        public RenderFluidPass(UnityEngine.Rendering.Universal.RenderTargetHandle colorHandle)
        {
        }
